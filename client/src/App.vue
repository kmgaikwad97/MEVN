    ...
    <div class="field has-addons">
      <div class="control is-expanded">
        <input
          ...
          v-model="description"
          class="input"
          placeholder="Meeting with Elon Musk.."
        />
      </div>
      <div class="control">
        <a class="button is-info" @click="addItem" :disable="!description"
          >Add</a
        >
      </div>
    </div>
    ...
    <div class="notification" v-for="(item, i) in items" :key="item._id">
      <div class="columns">
        <input
          ...
          class="column input"
        />
        <!-- <input type="text" v-if="selected._id === item._id" v-model="editedDescription" class="column input"> -->
